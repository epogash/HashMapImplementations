#include "RehashingHashMap.h"

void insert(){
	RehashingHashMap<int, int>* map = new RehashingHashMap<int, int>();
...
void insert_double(){
	RehashingHashMap<double, double>* map = new RehashingHashMap<double, double>();
...
void insert_cstring(){
	RehashingHashMap<char*, char*>* map = new RehashingHashMap<char*, char*>();
	char strA[] = "A";
	char strB[] = "B";
	char strC[] = "C";
	char strD[] = "D";
...
void insert_stdstring(){
	RehashingHashMap<std::string, std::string>* map = new RehashingHashMap<std::string, std::string>();
	std::string strA = "A";
	std::string strB = "B";
	std::string strC = "C";
	std::string strD = "D";

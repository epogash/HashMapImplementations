#include "QuadraticProbingHashMap.h"

void insert(){
	QuadraticProbingHashMap<int, int>* map = new QuadraticProbingHashMap<int, int>();
...
void insert_double(){
	QuadraticProbingHashMap<double, double>* map = new QuadraticProbingHashMap<double, double>();
...
void insert_cstring(){
	QuadraticProbingHashMap<char*, char*>* map = new QuadraticProbingHashMap<char*, char*>();
	char strA[] = "A";
	char strB[] = "B";
	char strC[] = "C";
	char strD[] = "D";
...
void insert_stdstring(){
	QuadraticProbingHashMap<std::string, std::string>* map = new QuadraticProbingHashMap<std::string, std::string>();
	std::string strA = "A";
	std::string strB = "B";
	std::string strC = "C";
	std::string strD = "D";

...
void insert(){
	RBST<int, int>* map = new RBST<int, int>(5);
	...
	map->print(std::cout);
	std::cout << "//Inserting another key//" << std::endl;
...
void insert_double(){
	RBST<double, double>* map = new RBST<double, double>();
...
void insert_cstring(){
	RBST<char*, char*>* map = new RBST<char*, char*>();
	char strA[] = "A";
	char strB[] = "B";
	char strC[] = "C";
	char strD[] = "D";
...
void insert_stdstring(){
	RBST<std::string, std::string>* map = new RBST<std::string, std::string>();
	std::string strA = "A";
	std::string strB = "B";
	std::string strC = "C";
	std::string strD = "D";
